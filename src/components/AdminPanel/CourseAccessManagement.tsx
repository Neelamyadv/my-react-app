  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto bg-[var(--admin-bg)] min-h-screen space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-[var(--admin-text)]">Course Access Management</h2>
          <p className="text-[var(--admin-text-secondary)]">Grant access to users by email - they'll see courses when they login</p>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-[var(--admin-card)] rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-[var(--admin-border)]">
            <h3 className="text-lg font-medium text-[var(--admin-text)] mb-4">
              Grant Course Access - {grantType === 'individual' ? 'Individual Courses' : 'Premium Pass (All Courses)'}
            </h3>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 max-h-60 overflow-y-auto border border-[var(--admin-border)] rounded-lg p-3 bg-[var(--admin-bg)]">
                    {courseData.map((course) => (
                      <label key={course.id} className="flex items-center gap-2 p-2 hover:bg-[var(--admin-border)] hover:bg-opacity-30 rounded cursor-pointer">
                        <input
                          type="checkbox"
